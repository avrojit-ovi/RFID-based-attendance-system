...
const char* ssid = "Web point LTD";
const char* password = "Wp333@ltd";
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
...
void loop() {
  ...
  if (readsuccess) {
    ...
    http.begin("http://103.115.27.65/NodeMCU-and-RFID-RC522-IoT-Projects/getUID.php");  //Specify request destination
